...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired
	private ProductRepository productRepoditory;
	
	@Autowired
	private OrderItemRepository orderItemRepository;
	
	
	//tudo que esta escrito nesse metodo vai rodas quando a app for iniciada
	@Override
	public void run(String... args) throws Exception {
		...
		productRepoditory.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
